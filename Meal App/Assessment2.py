...
root = tk.Tk()
root.geometry("1500x1000+200+0")  # initial size and position of the window
root.maxsize(1500, 1000)  # Set the maximum size of the window
root.minsize(1500, 1000)  # Set the minimum size of the window


# Load the image file
bg_image = ImageTk.PhotoImage(Image.open("bg2.jpg"))  # Load the background image
...
# Create a dropdown for meal categories
